...
for folder in folders:
    try:
        ...
        continue # scaffolds folder, unused
                ...
                with open(path,'r') as c:
                    for line in c:
                        ...
                        if len(genome_type) > 1: # this is the pairs we need
                            ...
                            if genome_type or int(genome_type) == 920 == "ancestor": # the 20th created genome, (second number - 900)*0.5 + 90 is the real similarity
                                genome = "Ancestor"
                            else:
                                genome = "Evolved"

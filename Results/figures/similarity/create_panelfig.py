...
ax1.set_title("E.coli genome fraction with different error profiles", size=18) 
...
ax2.set_title("Average genome fraction for all genomes", size=18)
...
f.text(0.08,0.5,"Genome fraction (%)",ha = 'center', va = 'center', rotation='vertical', size=18)
f.text(0.5,0.05,"Genome similarity (ANI)",ha = 'center', va = 'center', size=18)
plt.show()
